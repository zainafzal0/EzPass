...
function PasswordsPage() {
  ...
  return (
    <div>
      ...
      <AddPasswordModal setSendRequest={setSendRequest} setDefaultImg={setDefaultImg}/>

      <PasswordModal data={storedPasswords} storedPasswords={storedPasswords} setStoredPasswords={setStoredPasswords} modalIndex={infoModaIndex} modalRequest={modalRequest} setModalRequest={setModalRequest}/>
