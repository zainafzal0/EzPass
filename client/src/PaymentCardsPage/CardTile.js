...
function CardTile({ cardData,title,modalIndex,setModalRequest,index ,pageType,defaultImg,img}) {
    ...
    <div className="col-sm">
      ...
      >
        ...
        <div className="card-body">
            ...
            <img src={defaultImg==="true"?cardIcon: `https://logo.clearbit.com/${cardData.card_vendor}` } className="card-img-top" alt="..."></img>
            </div>
